...
class Comparer:
    ...
    def __init__( self, data_json: str ) -> None:
        ...
        #! human_decision not taken into account here
        ...
        self.behavior_obj = self.determine_behavior_comp()
    ...
    def determine_behavior_comp(self): #-> returns _DecisionPackage object that contains data
        ...
        #! multipying 1e8 for float truncation purposes..?
        ...
        # 1114 min_RO value changed 25 --> 10
        min_RO = 12
        if unique_pIDs > min_RO:
            decisionDict["RO"] += abs(unique_pIDs-min_RO)//3
            decisionDict["FS"] -= 1
            decisionDict["RC"] -= 1
...
class Visualizer:
    ...
    def path_plots(self, path: str, format: str):
        ...
        ax6.set_title("Disc X vs Crater X")
        ax6.set_xlabel("Time")
